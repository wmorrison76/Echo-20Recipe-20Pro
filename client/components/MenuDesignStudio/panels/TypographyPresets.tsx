        ...
        <div className="space-y-2 pr-4">
          {presets.map((preset) => (
            ...
            >
              {/* Preview */}
              <div
                className="mb-2 line-clamp-2 cursor-pointer hover:text-cyan-600 dark:hover:text-cyan-400"
                style={{
              ...
              <div className="flex gap-2">
                <Button
                  size="sm"
                  onClick={() => handleApplyPreset(preset)}
                  className="flex-1 h-7 text-xs bg-cyan-600 hover:bg-cyan-700 dark:bg-cyan-700 dark:hover:bg-cyan-800"
                >
                  Apply
                </Button>
