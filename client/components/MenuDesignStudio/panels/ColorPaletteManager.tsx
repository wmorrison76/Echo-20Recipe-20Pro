              ...
              {activePalette.colors.length === 0 ? (
                ...
                activePalette.colors.map((swatch) => (
                  ...
                  >
                    {/* Color Preview */}
                    <div
                      className="w-8 h-8 rounded-md border border-gray-300 dark:border-gray-600 cursor-pointer hover:ring-2 hover:ring-cyan-500 transition-all"
                    ...
                    <div className="flex-1 min-w-0">
                      <Input
                        ...
                        className="h-6 text-xs bg-transparent border-0 border-b border-transparent hover:border-gray-300 dark:hover:border-gray-600 focus:border-cyan-500 focus:bg-white dark:focus:bg-gray-900 p-0"
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-3">
            ...
            <div className="grid grid-cols-5 gap-2">
              {activePalette.colors.map((swatch) => (
                ...
                >
                  <div
                    className="w-full aspect-square rounded-md border border-gray-300 dark:border-gray-600 hover:ring-2 hover:ring-cyan-500 transition-all"
                    style={{ backgroundColor: swatch.color }}
                  />
                  <p className="text-xs text-center text-gray-600 dark:text-gray-400 mt-1 truncate group-hover:text-cyan-500">
                    {swatch.name}
                  </p>
                </div>
              ))}
