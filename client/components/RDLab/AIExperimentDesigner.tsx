...
export function AIExperimentDesigner() {
  ...
  return (
    <div className="w-full space-y-6 p-6 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 rounded-xl border border-cyan-500/10">
      {/* Header */}
      ...
      <div className="space-y-3">
        <div className="flex gap-2">
          ...
          <Button
            ...
            disabled={isLoading}
            className="gap-2 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 text-white border-0 whitespace-nowrap"
          >
            {isLoading ? (
              <>
      ...
      {design && (
        <div className="space-y-4">
          ...
          {/* Hypothesis */}
          <div className="space-y-2">
            <h3 className="text-sm font-semibold text-cyan-300">Hypothesis</h3>
