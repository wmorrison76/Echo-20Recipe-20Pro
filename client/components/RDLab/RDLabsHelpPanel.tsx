...
export function RDLabsHelpPanel({ isOpen, onClose }: RDLabsHelpPanelProps) {
  ...
  return (
    <div className="w-96 h-full flex flex-col border-l border-cyan-500/20 bg-gradient-to-b from-slate-900 to-slate-950">
      {/* Header */}
            ...
            {HELP_SECTIONS.map((section) => {
              ...
              return (
                <TabsTrigger
                  key={section.id}
                  value={section.id}
                  className="gap-1 rounded-none border-b-2 border-transparent data-[state=active]:border-cyan-400 data-[state=active]:bg-transparent text-xs"
                >
