  ...
  return (
    <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2 max-h-96 overflow-y-auto">
            {matches.map((match) => (
              <Card
                key={match.id}
                className="p-3 border border-accent/20 dark:border-cyan-500/20 cursor-pointer hover:border-accent/40 dark:hover:border-cyan-500/40 transition-colors"
      ...
      {!isLoading && matches.length === 0 && searchQuery.trim() && (
        <Card className="p-4 text-center border border-accent/20 dark:border-cyan-500/20">
