      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-3 border-t pt-4">
          ...
          <div className="space-y-2">
            <label className="flex items-center justify-center rounded-lg border-2 border-dashed border-white/20 bg-white/5 dark:border-cyan-500/20 dark:bg-cyan-500/5 px-4 py-6 cursor-pointer transition hover:border-white/40 dark:hover:border-cyan-500/40">
