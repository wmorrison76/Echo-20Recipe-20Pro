    ...
    <div className="fixed inset-0 z-40">
      ...
      {!displayOpen && (
        <button
          ...
          className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 flex items-center gap-2 px-4 py-2 rounded-lg bg-slate-900/80 border border-slate-700/50 hover:border-cyan-500/50 backdrop-blur-sm transition-all duration-300 group"
          title="Open Lab"
        >
