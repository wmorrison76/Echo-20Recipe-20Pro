      ...
      <CardContent className="space-y-6">
        ...
        {linkedRecipes.length > 0 ? (
          <div className="space-y-3">
            <p className="text-sm font-semibold">{linkedRecipes.length} linked recipe(s)</p>
            <div className="space-y-2">
              {linkedRecipes.map((recipe) => (
                <div
                  key={recipe.id}
                  className="flex items-center justify-between rounded-lg border border-white/10 bg-white/5 dark:border-cyan-500/20 dark:bg-cyan-500/5 p-3"
                >
          ...
          <div className="rounded-lg border border-dashed border-white/20 bg-white/5 dark:border-cyan-500/20 dark:bg-cyan-500/5 p-6 text-center space-y-3">
