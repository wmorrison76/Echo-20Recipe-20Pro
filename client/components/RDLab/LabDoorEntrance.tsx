          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="text-center space-y-4">
              <div className="flex justify-center gap-2">
                <Beaker className="h-12 w-12 text-cyan-600" />
            ...
            <div className="bg-muted/50 dark:bg-slate-900/50 p-8 rounded-lg border border-border dark:border-slate-800 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Button
                  ...
                  className="h-32 flex flex-col gap-3 items-center justify-center bg-cyan-600 hover:bg-cyan-700 text-white"
                >
              ...
              >
                <div className="absolute inset-0 flex items-center justify-center opacity-50">
                  <div className="animate-pulse">
                    <Beaker className="h-24 w-24 text-cyan-500" />
                  </div>
                </div>
              </div>
