            ...
            {timelineData.length > 0 ? (
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={timelineData}>
                  ...
                  />
                  <Legend />
                  <Bar dataKey="duration" fill="#06b6d4" name="Days" radius={[8, 8, 0, 0]} />
...
function InsightItem({ title, value, status, description }: InsightItemProps) {
  ...
  return (
    <div className="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200/30 dark:border-cyan-500/10">
      <div className="flex items-start justify-between">
        <div>
