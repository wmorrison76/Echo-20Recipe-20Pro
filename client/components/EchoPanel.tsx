...
export function EchoPanel({
  ...
  if (isCompact) {
    return (
      <div className={cn("rounded-lg border border-cyan-200 bg-cyan-50 p-3 dark:border-cyan-900 dark:bg-cyan-950/50", className)}>
  ...
  return (
    <div
      className={cn(
        "flex flex-col rounded-lg border border-cyan-300 bg-gradient-to-br from-cyan-50 to-blue-50 dark:border-cyan-700 dark:from-cyan-950 dark:to-blue-950",
        "space-y-4 p-4",
        className
      )}
    >
      ...
      {/* R&D Toolbar */}
      {isInitialized && (
        <div className="flex flex-wrap gap-2 border-t border-cyan-200 pt-2 dark:border-cyan-800">
      ...
      {/* Response Display */}
      {response && (
        <div className="space-y-2 rounded-md border border-cyan-200 bg-white p-3 dark:border-cyan-800 dark:bg-slate-900">
      ...
      {conversationHistory.length > 0 && (
        <div className="space-y-2 border-t border-cyan-200 pt-2 dark:border-cyan-800">
