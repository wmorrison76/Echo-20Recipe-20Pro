...
const RecipeInputPage = () => {
  ...
  return (
    <div className={`relative w-full h-screen transition-all duration-300 ${isDarkMode ? 'bg-black text-cyan-400' : 'bg-gray-50 text-gray-900'}`}>
      <div className={`fixed top-0 left-0 right-0 z-50 px-6 py-6 space-y-4 ${isDarkMode ? 'bg-gradient-to-br from-gray-900 via-black to-blue-900' : 'bg-gradient-to-br from-gray-50 to-white'}`}>
