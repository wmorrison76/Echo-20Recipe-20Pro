...
const RecipeInputPage = () => {
  ...
  const rndLabsOverlay = useMemo(() => {
    if (!isRndLabsOpen || typeof document === "undefined") return null;

    const handleClose = () => setIsRndLabsOpen(false);
    ...
    return createPortal(
      <div className="fixed inset-0 z-[110] flex items-center justify-center px-4 py-6">
        <div
          ...
          onClick={handleClose}
        />
        <div className="relative z-10 flex w-full max-w-[min(1220px,95vw)] flex-col">
          <div
            role="dialog"
            aria-modal="true"
          ...
          >
            <div className="relative z-10 flex h-full min-h-0 flex-col">
              <header className="relative z-10 flex shrink-0 items-center justify-between border-b border-white/10 bg-black/40 px-6 py-4 backdrop-blur-sm">
    ...
    accentMuted,
    handleRndLayoutChange,
    isDarkMode,
    isRndLabsOpen,
    rndHandleClasses,
    rndLayout,
    rndPanelBaseClasses,
    rndPanelHeadingClasses,
    rndPanelThemes,
    rndPanelToneClasses,
    setIsRndLabsOpen,
  ]);
            ...
            <div className="flex items-start gap-4 mt-1">
              ...
              >
                ...
                <IngredientsGrid
                  ...
                  onApplySupplierQuote={handleApplySupplierQuote}
                />
