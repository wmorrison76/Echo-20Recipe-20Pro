          ...
          <div className="flex flex-col h-full">
              ...
              <div>
                ...
                {clipboardUrl && (
                  <div className="text-xs text-blue-600 mt-1">
                    URL detected: {clipboardUrl.substring(0, 30)}...
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="flex-1 p-4 space-y-4 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200">
                ...
                {image && (
                  <div className="mt-2">
                    ...
                    <button
                      ...
                      onClick={() => {
                        const ev = new CustomEvent("openImageEditor", {
                          detail: { image },
                        });
              ...
              <fieldset className="mt-3 rounded-lg border p-3 bg-red-50/80">
                <legend className="px-1 text-sm font-semibold text-red-700">
                ...
                <div className="pr-1 grid grid-cols-2 gap-2">
                  {allergenList.map((a) => (
                    <label
                      key={a}
                      className="flex items-center gap-1 text-xs cursor-pointer hover:bg-red-100/50 p-1 rounded"
                    >
                      <input
                        type="checkbox"
                        ...
                        onChange={() =>
                          toggle(selectedAllergens, onAllergensChange, a)
                        }
                      />
              ...
              <fieldset className="mt-3 rounded-lg border p-3 bg-blue-50/80">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {nationalityList.map((n) => (
                    <label
                      key={n}
                      className="flex items-center gap-1 text-xs cursor-pointer hover:bg-blue-100/50 p-1 rounded"
                    >
                      <input
                        type="checkbox"
                        className="scale-75 text-blue-600"
                        checked={selectedNationality.includes(n)}
                        onChange={() =>
                          toggle(selectedNationality, onNationalityChange, n)
                        }
                      />
                  ...
                  {coursesList.map((c) => (
                    ...
                    >
                      <input
                        ...
                        onChange={() =>
                          toggle(selectedCourses, onCoursesChange, c)
                        }
                      />
              ...
              <fieldset className="mt-3 rounded-lg border p-3 bg-blue-50/80">
                <legend className="px-1 text-sm font-semibold text-blue-700">
                  Recipe Type ({selectedRecipeType.length})
                </legend>
                  ...
                  {recipeTypeList.map((t) => (
                    ...
                    >
                      <input
                        type="checkbox"
                        className="scale-75 text-blue-600"
                        checked={selectedRecipeType.includes(t)}
                        onChange={() =>
                          toggle(selectedRecipeType, onRecipeTypeChange, t)
                        }
                      />
              ...
              <fieldset className="mt-3 rounded-lg border p-3 bg-blue-50/80">
                <legend className="px-1 text-sm font-semibold text-blue-700">
                  Preparation Method ({selectedPrepMethod.length})
                </legend>
                <div className="grid grid-cols-2 gap-2">
                  {prepMethodList.map((m) => (
                    ...
                    >
                      <input
                        type="checkbox"
                        className="scale-75 text-blue-600"
                        checked={selectedPrepMethod.includes(m)}
                        onChange={() =>
                          toggle(selectedPrepMethod, onPrepMethodChange, m)
                        }
                      />
              ...
              <fieldset className="mt-3 rounded-lg border p-3 bg-blue-50/80">
                <legend className="px-1 text-sm font-semibold text-blue-700">
                  Cooking Equipment ({selectedCookingEquipment.length})
                </legend>
                <div className="grid grid-cols-2 gap-2">
                  {cookingEquipmentList.map((m) => (
                    ...
                    >
                      <input
                        type="checkbox"
                        className="scale-75 text-blue-600"
                        checked={selectedCookingEquipment.includes(m)}
                        onChange={() =>
                          toggle(
                            selectedCookingEquipment,
                            onCookingEquipmentChange,
              ...
              <fieldset className="mt-3 rounded-lg border p-3 bg-blue-50/80">
                <legend className="px-1 text-sm font-semibold text-blue-700">
                  Recipe Access ({selectedRecipeAccess.length})
                </legend>
                <div className="grid grid-cols-2 gap-2">
                  {recipeAccessList.map((m) => (
                    ...
                    >
                      <input
                        ...
                        onChange={() =>
                          toggle(selectedRecipeAccess, onRecipeAccessChange, m)
                        }
                      />
                      <span className="text-blue-700">{m}</span>
                    </label>
