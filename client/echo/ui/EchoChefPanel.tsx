...
export const EchoChefPanel: React.FC<EchoChefPanelProps> = ({
  ...
  return (
    <div className="w-full max-w-5xl mx-auto rounded-2xl border border-white/10 bg-black/40 backdrop-blur-md p-4 text-white">
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div className="flex justify-end gap-2 pt-2">
          <button
            ...
            className="px-4 py-2 rounded-full text-xs font-medium bg-cyan-400 hover:bg-cyan-300 text-black disabled:bg-white/10 disabled:text-white/40 transition"
          >
            {isLoading
              ? "Echo is thinking..."
              : mode === "generate"
        ...
        <div className="mt-6 space-y-3">
          ...
          {suggestions.map((s, idx) => (
            ...
            >
              ...
              {s.serviceNotes && (
                <p className="text-[11px] text-white/60 italic border-l border-cyan-400/40 pl-2">
                  {s.serviceNotes}
                </p>
              )}
            </div>
      ...
      {recipeDraft && (
        <div className="mt-6 rounded-2xl bg-gradient-to-br from-cyan-900/20 to-white/5 border border-cyan-400/40 p-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
            <div>
              <h4 className="font-semibold text-xs mb-2 text-cyan-300">
                Ingredients
              </h4>
          ...
          {recipeDraft.miseEnPlace && recipeDraft.miseEnPlace.length > 0 && (
            <div className="mb-3">
              <h4 className="font-semibold text-xs mb-1 text-cyan-300">
                Mise en Place
              </h4>
