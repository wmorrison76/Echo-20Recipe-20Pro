...
/**
 * POST /api/pinecone/recipes/store
...
/**
 * POST /api/pinecone/recipes/search
...
/**
 * GET /api/pinecone/recipes/by-track
 * Get all recipes by track
 */
...
/**
 * POST /api/pinecone/recipes/delete
...
/**
 * POST /api/pinecone/cross-track-learning
 * Get cross-track learning suggestions (manufacturing chefs learning from fine dining)
 */
...
/**
 * POST /api/pinecone/embedding
 * Generate an embedding for text (useful for client-side testing)
 */
