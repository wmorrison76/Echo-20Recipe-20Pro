...
/**
 * Tablet Device Pairing Service
 * Handles QR code generation, device registration, and authentication
 */
...
/**
 * Generate QR code data for tablet device setup
 * The QR code contains a setup URL with device credentials
 */
...
/**
 * Generate a QR code image URL for the pairing data
 * Uses QR Server API
 */
